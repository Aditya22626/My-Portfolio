...
export default function Nav() {
  ...
  const socialLinks = [
    { icon: <FaGithub size={22} />, href: "https://github.com/Aditya22626", label: "GitHub" },
    { icon: <FaLinkedin size={22} />, href: "https://www.linkedin.com/in/aditya-kaushik-b4b00b338/", label: "LinkedIn" },
