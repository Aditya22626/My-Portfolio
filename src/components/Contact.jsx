...
const Contact = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch("https://getform.io/f/agdlkklb", {
        method: "POST",
        body: formData,
        headers: {
            ...
            <div className="space-y-6">
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <a href="adityakaushik22626@gmail.com" className="text-neutral-400 hover:text-indigo-400 transition-colors">adityakaushik22626@gmail.com</a>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-neutral-400">Sonipat, Haryana, India</p>
                </div>
              </div>
            </div>
