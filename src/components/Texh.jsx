...
import { SiMongodb, SiPostgresql, SiMysql, SiTensorflow, SiJavascript, SiTailwindcss, SiGit, SiPytorch, SiAngular } from 'react-icons/si';
import { FaNodeJs, FaPython, FaCode, FaDatabase, FaServer, FaTools, FaJava } from 'react-icons/fa';
  ...
  const categories = [
    {
      ...
      skills: [
        ...
        { name: "Angular", icon: <SiAngular className="text-blue-500" size={36} /> },
    ...
    },
    {
      ...
      skills: [
        ...
        { name: "Java", icon: <FaJava className="text-teal-500" size={36} /> },
        { name: "C++", icon: <FaC className="text-gray-300" size={36} /> },
      ]
    },
    {
      name: "Database",
